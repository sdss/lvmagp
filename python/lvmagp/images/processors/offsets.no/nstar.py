...
from lvmagp.images import Image, ImageProcessor
from lvmagp.mixins.pipeline import PipelineMixin
from lvmagp.images.meta import PixelOffsets
...
class NStarOffsets(Offsets, PipelineMixin):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Requires lvmagp.images.processors.detection.SepSourceDetection and
        lvmagp.images.processors.photometry.SepPhotometry to be run on the image beforehand.
