...
try:
    ...
    __version__ = get_package_version(__file__, "sdss-lvmagp") or "dev"
...
.. |lvmagp_version| replace:: {__version__}
"""
...
htmlhelp_basename = "{0}pdoc".format("lvmagp")
...
man_pages = [(master_doc, "lvmagp", "{0} Documentation".format(project), [author], 1)]
